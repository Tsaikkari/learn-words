    ...
    <div className="top-group">
      ...
      <div className="score">
        <div className="score-result rights-score">
          ...
          <p className="right-answer">{(props.onClick && props.rightAnswer) && props.rightAnswer}</p>
        </div>
        <div className="score-result wrongs-score">
          <i className="fas fa-times-circle fa-3x"></i><br></br>
          <p className="wrong-answer">{(props.onClick && props.wrongAnswer) && props.wrongAnswer}</p>
        </div>
      </div>
    </div>
  );
